/*!
 * simpleGallery v1.0.0 jQuery plugin
    ...
    simpleGallery: function(options, callback) {
      ...
      return this.each(function() {
        ...
        if (o.height > o.width) {
          ...
          he = o.height - 20;
          prev = "preview";
          down.children('img').load(function() {
            up.children('img').load(function() {
            down.css("left", (Number(obj.css('margin-left').match(/\d+/g)[0]) + o.width) / 2 - down.children('img').width() / 2);
            up.css("left", (Number(obj.css('margin-left').match(/\d+/g)[0]) + o.width) / 2 - up.children('img').width() / 2);
            });
          });
        } else {
          wh = o.width - 20;
          ...
          down.children('img').load(function() {
            up.children('img').load(function() {
              down.css("top", (Number(obj.css('margin-top').match(/\d+/g)[0]) + o.height) / 2 - down.children('img').height() / 2);
              up.css("top", (Number(obj.css('margin-top').match(/\d+/g)[0]) + o.height) / 2 - down.children('img').height() / 2);
            });
          });
        }
